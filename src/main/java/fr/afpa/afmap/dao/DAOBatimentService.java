    ...
    public BatimentAdministratif find(long id) {
        try {
            ...
            if (result.first()) {
                ...
                ArrayList<ArrayList<Double>> allPointsToDouble = floatToArrayListDouble(allPointsToFloat);
    ...
    public ArrayList<BatimentAdministratif> findAll() {
        ...
        try {
            ...
            while (r.next()) {
                ...
                for (BatimentAdministratif batimentAdministratif : batimentAdministratifs){
                    if (batimentAdministratif.getId() == batiment.getId()) {
                        isAlreadyIn = true;
                        break;
                    }
                }
